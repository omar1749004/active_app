...
class CustomTraineingDayContainer extends StatelessWidget {
  const CustomTraineingDayContainer({super.key, this.onTap});
            ...
            Column(
              ...
              children: [
               Container(
                ...
                child: Text("اليوم الاول" , style: Styles.style15G2W4,),
               ),
               Text("All Body Hustle" ,style: Styles.style20BW4,),
                Text("41 - 60 دقيقة" ,style: Styles.style15G2W4,)
              ],
            ),
          const  Spacer() ,
            Icon(Icons.arrow_forward ,color : ColorApp.gray2)
          ],
        ),
      ),
    );
